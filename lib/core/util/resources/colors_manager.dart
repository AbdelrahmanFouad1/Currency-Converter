...
class ColorsManager {
  ///Primary Colors
  static const Color primary = Color(0xff694df8);
  ...
  static const Color onSecondaryLight = Color(0xff171e2c);
  static const Color secondaryContainerLight = Color(0xff1f2530);
  ...
  static const Color error = Color(0xffff345b);
  static const Color info = Color(0xff2b87ec);
